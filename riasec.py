...
DESCRIPTIONS = {
    "R": {
        "title": "Realistic",
        "desc_first_person": "people are often good at mechanical or athletic jobs.",
        "majors": ["Agriculture", "Health Assistant", "Computers",
                   "Construction", "Mechanic/Machinist", "Engineering",
                   "Food and Hospitality"],
    },
    "I": {
        "title": "Investigative",
        "desc_first_person": "people like to watch, learn, analyze and solve problems.",
        "majors": ["Marine Biology", "Engineering", "Chemistry", "Zoology",
                   "Medicine/Surgery", "Consumer Economics", "Psychology"],
    },
    "A": {
        "title": "Artistic",
        "desc_first_person": "people like to work in unstructured situations where they can use their creativity.",
        "majors": ["Communications", "Cosmetology",
                   " Fine and Performing Arts", "Photography", "Radio and TV", "Interior Design",
                   "Architecture"],
    },
    "S": {
        "title": "Social",
        "desc_first_person": "people like to work with other people, rather than things.",
        "majors": ["Counselling", "Nursing", "Physical Therapy", "Travel",
                   "Advertising", "Public Relations", "Education"],
    },
    "E": {
        "title": "Enterprising",
        "desc_first_person": "people like to work with others and enjoy persuading and performing.",
        "majors": ["Fashion Merchandising", "Real Estate",
                   "Marketing/Sales", "Law", "Political Science",
                   "International Trade", "Banking/Finance"],
    },
    "C": {
        "title": "Conventional",
        "desc_first_person": "people are very detail oriented,organized and like to work with data.",
        "majors": ["Accounting", "Court Reporting", "Insurance", "Administration",
